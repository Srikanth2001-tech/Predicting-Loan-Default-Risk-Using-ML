...
## **Research Questions**
1. How do modern ensemble learning techniques compare to traditional credit scoring 
models in predicting loan default risk? 
2. Which borrower attributes (income, credit history, employment stability) are most 
influential in default prediction? 
3. How do cost-sensitive learning methods mitigate the risks of false negatives in financial 
lending decisions?
...
- **SHAP** for model interpretability and explainable AI analysis.
...
3. **Model Training:**
   - **Logistic Regression**, **K-Nearest Neighbors (KNN)**, and **XGBoost** models are trained to predict the credit risk.
4. **Model Evaluation:**
...
5. **Hyperparameter Tuning:** Optuna (Bayesian Optimization) is used to fine-tune the hyperparameters of the K-Nearest Neighbors (KNN) and XGBoost models.
...
## **Results**
This project compares multiple machine learning models for predicting loan default risk. The **K-Nearest Neighbors (KNN)** and **XGBoost** models provide strong performance in terms of accuracy, precision, recall, and ROC-AUC. **Feature importance** is analyzed to identify the key factors influencing the default risk prediction.
